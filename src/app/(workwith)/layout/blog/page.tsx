...
function Page() {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement> | React.MouseEvent) => {
    e.preventDefault();
    try {
      setLoading(true);
  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200">
        ...
        <p className="mt-8 text-sm font-medium">Category</p>
        ...
        {!content ? (
          <div className="flex-1 flex justify-center items-center">
            <div className="text-sm flex-col items-center gap-5 text-gray-400 text-center">
              <span className="w-5 h-5 text-5xl block mx-auto">#</span>
